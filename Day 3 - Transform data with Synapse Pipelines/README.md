# Module - Transform data with Azure Data Factory or Azure Synapse Pipelines

This module teaches how to build data integration pipelines to ingest from multiple data sources, transform data using mapping data flows and notebooks, and perform data movement into one or more data sinks.
...
- [Module - Transform data with Azure Data Factory or Azure Synapse Pipelines](#Module---transform-data-with-azure-data-factory-or-azure-synapse-pipelines)
